...
public class ServerListResult {
    ...
    @Expose
    private Double storageTotalSsdTb;
    ...
    @Expose
    private Double storageTotalSataTb;
...
//    private Ipv4 ipv4;
    ...
    public Double getStorageTotalSsdTb() {
        return storageTotalSsdTb;
    }

    public void setStorageTotalSsdTb(Double storageTotalSsdTb) {
    ...
    public Double getStorageTotalSataTb() {
        return storageTotalSataTb;
    }

    public void setStorageTotalSataTb(Double storageTotalSataTb) {
    ...
    public Double getStorageTotalTb() {
        return storageTotalTb;
    }

    public void setStorageTotalTb(Double storageTotalTb) {
